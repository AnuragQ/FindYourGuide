"""
Django settings for FindYourGuide project.
...
SECRET_KEY = 'django-insecure-6*nx*jw$un^+&auv1@1r=hkh_)oi(w_mgt3b@$(yl!2qx&hc=r'
...
ROOT_URLCONF = 'FindYourGuide.urls'
...
WSGI_APPLICATION = 'FindYourGuide.wsgi.application'
